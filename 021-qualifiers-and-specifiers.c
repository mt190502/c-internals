...
int main(void) {
    ...
    (*ptr)++;
    (ptr2)++;   // if (*ptr2)++; is used, it will throw an error because it is a
                // constant value
    (*ptr3)++;  // if (ptr3)++; is used, it will throw an error because it is a
                // constant pointer
    ...
    // register: register keyword is used to define local variables that should be
